...
var Swal = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js"); // Validate checkbox terms


if (document.getElementById("field_terms")) {
  document.getElementById("field_terms").setCustomValidity("Debes aceptar tratamiento de mis datos personales, políticas de privacidad y los términos y condiciones");
}
...
if (formRegister) {
  formRegister.onsubmit = function (event) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbwO8wJTKRVrxB3cBD9wOAH4oU7GWtJvNa8iw7uTZA/exec', {
      method: 'POST',
      body: formData
      ...
      if (data.result === "success") {
        ...
        fetch("https://us-central1-pomar-a7a82.cloudfunctions.net/date?email=".concat(email, "&name=").concat(name)).then(function (response) {
          return response.json();
        }).then(function () {
...
var formRegisterAliso = document.getElementById("form-register-aliso");
var buttonSubmitAliso = document.getElementById('button-submit-aliso');
...
if (formRegisterAliso) {
  formRegisterAliso.onsubmit = function (event) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbxYg05IY9VaKS9dpca6Da-Oa8BdTWzQKEc59H1p/exec', {
      method: 'POST',
      body: formData
    }).then(function (response) {
      return response.json();
...
var swiper2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container-plant', {
  parallax: true,
  loop: true,
  navigation: {
...
var titlGallery = document.getElementById("title-gallery");
swiper.on('slideChange', function () {
  ...
  switch (swiper.realIndex) {
    ...
    case 1:
      text = 'Primera etapa: Aptos de 54.73m² <p>*Área privada 49.73m²</p> Aptos 58.30m² <br/> <p>*Área privada 52.48m²</p>  ';
      titlGallery.innerHTML = text;
      return text;

    case 2:
      text = "Un refugio verde, decar de todo y con las áreas más grandes del sector";
      titlGallery.innerHTML = text;
      return Text;
...
var map1 = document.getElementById('image-map-1');
var map2 = document.getElementById('image-map-2');
var map3 = document.getElementById('image-map-3');
...
__webpack_require__(/*! /Users/oscarsoler/Documents/proyectos-ekoomedia/pomar-landing/source/_assets/js/main.js */"./source/_assets/js/main.js");
module.exports = __webpack_require__(/*! /Users/oscarsoler/Documents/proyectos-ekoomedia/pomar-landing/source/_assets/sass/main.scss */"./source/_assets/sass/main.scss");
